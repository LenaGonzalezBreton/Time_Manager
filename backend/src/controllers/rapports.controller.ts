...
export async function getRapports(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    // Construire l'objet de filtres sans undefined
...
export async function postRapportsRecompute(_req: Request, res: Response, next: NextFunction) {
  try {
    // pas d'effet de bord, ne recalcul rien pour le moment
