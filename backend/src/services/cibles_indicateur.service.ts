...
export async function createCibleIndicateur(data: { type_cible: "utilisateur" | "equipe"; id_cible: number; }) {
...
export async function updateCibleIndicateur(
    ...
    data: Partial<{ type_cible: "utilisateur" | "equipe"; id_cible: number; }>
) {
