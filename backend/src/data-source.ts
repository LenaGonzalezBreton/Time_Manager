...
export const AppDataSource = new DataSource({
    ...
    entities: [__dirname + "/entities/*.{ts,js}"],                                      // Chemin vers les entités, * permet de prendre tous les fichiers .ts et .js
    migrations: [__dirname + "/migrations/*.{ts,js}"],                                  // Chemin vers les migrations
