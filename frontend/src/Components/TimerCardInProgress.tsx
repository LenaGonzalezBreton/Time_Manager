...
const TimerCardInProgress=() => {
    ...
    return(
        <div className="flex flex-col gap-8 border-2 border-black p-3 w-1/3 h-full rounded-xl">
            ...
            <div className="flex flexrow gap-4 justify-center">
                <button className="!bg-white !border-2 w-2/5 justify-center !border-black text-black hover:!bg-gray-400 active:scale-95 transition transform duration-150 ease-out flex flex-row gap-2"> <LucideCoffee/>  Pause </button>
                <button className="!bg-blue-950 w-2/5 justify-center hover:!bg-blue-600 active:scale-95 transition transform duration-150 ease-out"> Terminer </button>
