...
const TimerCardInProgress=() => {
    ...
    return(
        <div className="flex flex-col gap-8 border-2 border-black p-3 rounded-xl">
            ...
            <div className="flex flexrow gap-4 justify-center">
                <button className="!bg-white !border-2 !border-black text-black hover:!bg-gray-400 active:scale-95 transition transform duration-150 ease-out flex flex-row gap-2"> <LucideCoffee/>  Pause </button>
                <button className="!bg-blue-950 hover:!bg-blue-600 active:scale-95 transition transform duration-150 ease-out"> Terminer </button>
