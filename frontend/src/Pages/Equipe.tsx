...
export default function Equipe() {
    ...
    `}
            ...
            <main className="flex flex-col p-2 w-full h-screen overflow-y-auto gap-10">
                <label className="text-3xl font-semibold text-blue-950 mt-2 ml-8">
                    Bonjour Tom Scheffmann !
                </label>
                <div className="flex md:flex-row flex-col items-center gap-5 ">
                    <div className="flex flex-col md:w-2/3 w-9/10 p-3 border-black border-2 rounded-2xl">
                    ...
                    <div className="w-1/3r"><Card_manager/></div>
                </div>
            </main>
