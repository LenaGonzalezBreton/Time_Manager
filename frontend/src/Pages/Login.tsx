...
export default function Login(){
    return (
        <div className="w-screen h-screen  justify-center flex flex-col text-blue-950 bg-gray-300">
                ...
                <div className ="w-1/4 justify-center flex flex-col bg-blue-300 rounded-2xl gap-2 p-3 border-2 border-blue-950">
                    <div className= "flex flex-col justify-between gap-4">
                        <label htmlFor="email" className="font-bold text-xl" > Adresse mail </label>
                        <input className="bg-blue-950 p-1 pl-3 rounded-3xl placeholder-white  mr-1 ml-1 p-2 " placeholder="exemple@domine.com"/>
                        <input className="bg-blue-950 p-1 pl-3 rounded-3xl placeholder-white  mr-1 ml-1  p-2" type="password" id="password" placeholder="••••••••"/>
                    ...
                    <label className=" "> Pas encore de compte? <a href="Inscris toi" className="!text-blue-850">Inscris toi </a>
                    </label>
                </div>
                </div>
